...
%DXC% -HV 2021 -Zpr -O3 -auto-binding-space 0 -Wno-parentheses-equality -disable-lifetime-markers -T cs_6_6 -E MainComputeShader -Fc GenerateOctreeShader.d3dasm -Fo GenerateOctreeShader.dxil GenerateOctreeShader.usf
:END
PAUSE
